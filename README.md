...
| [sserpolar/devdocs-lookup](https://github.com/sserpolar/devdocs-lookup)                     | Browser extension (right-click lookup in a popup window) | ![Latest GitHub commit](https://img.shields.io/github/last-commit/sserpolar/devdocs-lookup?logo=github&label) | ![GitHub stars](https://img.shields.io/github/stars/sserpolar/devdocs-lookup?logo=github&label) |
| ![Latest GitHub commit](https://img.shields.io/github/last-commit/gruehle/dev-docs-viewer?logo=github&label)         | ![GitHub stars](https://img.shields.io/github/stars/gruehle/dev-docs-viewer?logo=github&label)         |
